...
exports.update = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: 'Profil mis à jour avec succès', agriculteur });
  } catch (error) {
...
exports.updatePassword = async (req, res) => {
  try {
    ...
    const currentPasswordValid = await argon2.verify(agriculteur.password, currentPassword);
    ...
    agriculteur.password = hashedNewPassword;
    await agriculteur.save();
