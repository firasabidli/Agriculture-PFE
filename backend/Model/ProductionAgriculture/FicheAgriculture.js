...
const ficheSchema = new mongoose.Schema({
    ...
    historiqueIrrigation: [{ type: mongoose.Schema.Types.ObjectId, ref: 'HistoriqueIrrigation' }],
    historiqueMainOeuvre: [{ type: mongoose.Schema.Types.ObjectId, ref: 'HistoriqueMainOeuvre' }],
    historiqueRecolt: [{ type: mongoose.Schema.Types.ObjectId, ref: 'HistoriqurRecolte' }],
});
